...
// Needed for Heroku.
const databaseUrl = Env.get('DATABASE_URL') ? new Url(Env.get('DATABASE_URL')) : null
  ...
  connections: {
    ...
    */
    pg: {
      client: 'pg',
      connection: {
        host: databaseUrl     ? databaseUrl.resource           : Env.get('PG_HOST'),
        port: databaseUrl     ? databaseUrl.port               : Env.get('PG_PORT'),
